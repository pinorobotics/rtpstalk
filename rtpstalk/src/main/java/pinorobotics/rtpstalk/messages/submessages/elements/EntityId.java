...
public class EntityId {
    ...
    public static enum Predefined {
        ...
        ENTITYID_SEDP_BUILTIN_TOPICS_ANNOUNCER(
                new EntityId(new byte[] {00, 00, 02}, BUILTIN_WRITER)),
        ENTITYID_SEDP_BUILTIN_TOPICS_DETECTOR(
                new EntityId(new byte[] {00, 00, 02}, BUILTIN_READER)),
        ...
        ENTITYID_SEDP_BUILTIN_PUBLICATIONS_DETECTOR(
                new EntityId(new byte[] {00, 00, 03}, BUILTIN_READER)),
        ...
        ENTITYID_SPDP_BUILTIN_PARTICIPANT_ANNOUNCER(
                new EntityId(new byte[] {00, 01, 00}, BUILTIN_WRITER)),
        ENTITYID_SPDP_BUILTIN_PARTICIPANT_DETECTOR(
                new EntityId(new byte[] {00, 01, 00}, BUILTIN_READER)),
