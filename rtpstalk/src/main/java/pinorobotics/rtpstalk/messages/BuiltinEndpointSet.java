...
public class BuiltinEndpointSet {
    ...
    public static enum Endpoint {
        ...
        SECURE_SUBSCRIPTION_WRITER(18),
        SECURE_SUBSCRIPTION_READER(19),
        SECURE_PARTICIPANT_MESSAGE_WRITER(20),
        SECURE_PARTICIPANT_MESSAGE_READER(21),
        PARTICIPANT_STATELESS_MESSAGE_WRITER(22),
        PARTICIPANT_STATELESS_MESSAGE_READER(23),
        SECURE_PARTICIPANT_VOLATILE_MESSAGE_WRITER(24),
        SECURE_PARTICIPANT_VOLATILE_MESSAGE_READER(25),
        PARTICIPANT_SECURE_WRITER(26),
        PARTICIPANT_SECURE_READER(27),
