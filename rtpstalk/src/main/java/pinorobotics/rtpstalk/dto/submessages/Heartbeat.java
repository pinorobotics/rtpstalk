...
public class Heartbeat extends Submessage {
	 ...
	 * Can be set to {@link EntityId#ENTITYID_UNKNOWN} to indicate all readers
	...
	/**
	 * If samples are available in the Writer, identifies the first
	 * (lowest) sequence number that is available in the Writer.
	 ...
	 * If set means the Writer does not require a response from the Reader.
	 */
