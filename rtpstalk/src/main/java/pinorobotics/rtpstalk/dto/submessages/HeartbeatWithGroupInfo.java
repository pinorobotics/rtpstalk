...
public class HeartbeatWithGroupInfo extends Heartbeat {
	...
	/**
	 * Present only if the GroupInfo flag is set in the header.
	 * Identifies the last (highest) group sequence number written by
	 * any DataWriter in the Writer���s Group at the time that the
	 * HeartBeat was sent.
	 */
	 ...
	 * sample identified by sequence number firstSN.
	 */
	 ...
	 * Present only if the GroupInfo flag is set in the header.
	 * Identifies the group sequence number corresponding to the
	 * sample identified by sequence number lastSN.
	 */
	 ...
	 * secureWriterSet GroupDigest Present only if the GroupInfoFlag is set in the header.
