...
public class SedpBuiltinSubscriptionsReader extends StatefullRtpsReader {
    ...
    public SedpBuiltinSubscriptionsReader(GuidPrefix guidPrefix) {
        super(new Guid(guidPrefix, EntityId.Predefined.ENTITYID_SEDP_BUILTIN_SUBSCRIPTIONS_DETECTOR.getValue()));
    }
