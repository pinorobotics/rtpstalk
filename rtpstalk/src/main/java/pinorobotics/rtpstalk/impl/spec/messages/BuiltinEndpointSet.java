...
public class BuiltinEndpointSet {
    ...
    public static enum Endpoint {
        ...
        /**
         * The following have been deprecated in version 2.4 of the specification. These bits should
         * not be used by versions of the protocol equal to or newer than the deprecated version
         * unless they are used with the same meaning as in versions prior to the deprecated
         * version.
         */
        ...
        /**
         * Bits 12-15 have been reserved by the DDS-Xtypes 1.2 Specification and future revisions
         * thereof.
         */

        /**
         * Bits 16-27 have been reserved by the DDS-Security 1.1 Specification and future revisions
         * thereof.
         */
        ...
        DISC_BUILTIN_ENDPOINT_TOPICS_ANNOUNCER(
                28,
                EndpointType.WRITER,
                EntityId.Predefined.ENTITYID_SEDP_BUILTIN_TOPICS_ANNOUNCER),
        DISC_BUILTIN_ENDPOINT_TOPICS_DETECTOR(
                29, EndpointType.READER, EntityId.Predefined.ENTITYID_SEDP_BUILTIN_TOPICS_DETECTOR),

        UNKNOWN(-1, EndpointType.UNKNOWN);

        static final Map<Integer, Endpoint> MAP =
                Arrays.stream(Endpoint.values()).collect(Collectors.toMap(k -> k.position, v -> v));
    ...
    public static final BuiltinEndpointSet ALL =
