...
bool HelloWorldPublisher::init()
{
    ...
    auto cstr = getenv("RTPS_TopicDataType");
    Wparam.topic.topicDataType = cstr != NULL? cstr: "HelloWorld";
    ...
    valueMapping["VOLATILE_DURABILITY_QOS"] = VOLATILE_DURABILITY_QOS;
    valueMapping["TRANSIENT_LOCAL_DURABILITY_QOS"] = TRANSIENT_LOCAL_DURABILITY_QOS;

    cstr = getenv("RTPS_DurabilityQosPolicyKind");
    if (cstr != NULL) {
      auto value = string(cstr);
      if (valueMapping.find(value) == valueMapping.end()) {
